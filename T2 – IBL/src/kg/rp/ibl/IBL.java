...
public class IBL
{
	...
	private void executar(String arqTreino)
	{
		...
		// Cria a descrição conceitual
		tamanhoDasAmostras = amostras.get(0).amostra().tamanho();
		switch (nívelIBL)
		{
			case 1: dc = new DescritorConceitualIBL1(tamanhoDasAmostras);
				break;
			case 2: dc = new DescritorConceitualIBL2(tamanhoDasAmostras);
				break;
			case 3: dc = new DescritorConceitualIBL3(tamanhoDasAmostras);
				break;
			default:
				args.uso();
		}
